...
function goHide6() {
	if (!isOver11111 && !isOver22222) {
		$('.gnb_depth2_6').stop().fadeOut('fast');
	}
}
...
function goHide7() {
	if (!isOver11111 && !isOver22222) {
		$('.gnb_depth2_7').stop().fadeOut('fast');
	}
}
...
$(document).ready( function() {
  ...
  //gnb_depth2_5	
	$('.openAll5').mouseover(function(){
		if ( parseInt($('header').css('width')) > 800 ) $('.gnb_depth2_5').fadeIn('fast');
		isOver111 = true;
	});
	$('.openAll5').focus(function(){
		if ( parseInt($('header').css('width')) > 800 ) $('.gnb_depth2_5').fadeIn('fast');
		isOver111 = true;
	});
	$('.openAll5').mouseout(function(){
		isOver111 = false;
		setTimeout("goHide5()",200);
	});	
	$('.gnb_depth2_5 li:last-child a').blur(function(){
		isOver111 = false;
		setTimeout("goHide5()",200);
	});	
	$('.gnb_depth2_5').mouseover(function(){
		isOver222 = true;			
	});	
	$('.gnb_depth2_5').focus(function(){
		isOver222 = true;			
	});	
	$('.gnb_depth2_5').mouseout(function(){
		isOver222 = false;
		setTimeout("goHide5()",200);
	});	
	$('.gnb_depth2_5').blur(function(){
		isOver222 = false;
		setTimeout("goHide5()",200);
	});	
    
	//gnb_depth2_6	
	$('.openAll6').mouseover(function(){
		if ( parseInt($('header').css('width')) > 800 ) $('.gnb_depth2_6').fadeIn('fast');
		isOver111 = true;
	});
	$('.openAll6').focus(function(){
		if ( parseInt($('header').css('width')) > 800 ) $('.gnb_depth2_6').fadeIn('fast');
		isOver111 = true;
	});
	$('.openAll6').mouseout(function(){
		isOver111 = false;
		setTimeout("goHide6()",200);
	});	
	$('.gnb_depth2_6 li:last-child a').blur(function(){
		isOver111 = false;
		setTimeout("goHide6()",200);
	});	
	$('.gnb_depth2_6').mouseover(function(){
		isOver222 = true;			
	});	
	$('.gnb_depth2_6').focus(function(){
		isOver222 = true;			
	});	
	$('.gnb_depth2_6').mouseout(function(){
		isOver222 = false;
		setTimeout("goHide6()",200);
	});	
	$('.gnb_depth2_6').blur(function(){
		isOver222 = false;
		setTimeout("goHide6()",200);
	});	
	//gnb_depth2_7	
	$('.openAll7').mouseover(function(){
		if ( parseInt($('header').css('width')) > 800 ) $('.gnb_depth2_7').fadeIn('fast');
		isOver111 = true;
	});
	$('.openAll7').focus(function(){
		if ( parseInt($('header').css('width')) > 800 ) $('.gnb_depth2_7').fadeIn('fast');
		isOver111 = true;
	});
	$('.openAll7').mouseout(function(){
		isOver111 = false;
		setTimeout("goHide7()",200);
	});	
	$('.gnb_depth2_7 li:last-child a').blur(function(){
		isOver111 = false;
		setTimeout("goHide7()",200);
	});	
	$('.gnb_depth2_7').mouseover(function(){
		isOver222 = true;			
	});	
	$('.gnb_depth2_7').focus(function(){
		isOver222 = true;			
	});	
	$('.gnb_depth2_7').mouseout(function(){
		isOver222 = false;
		setTimeout("goHide7()",200);
	});	
	$('.gnb_depth2_7').blur(function(){
		isOver222 = false;
		setTimeout("goHide7()",200);
	});	
